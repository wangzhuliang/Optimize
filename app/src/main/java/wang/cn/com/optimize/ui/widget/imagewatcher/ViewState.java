...
/**
 * @author: wangZL
 * @description: ViewState包含记录了一个View的瞬时UI状态<br/>
 * 并且提供了给View新增状态，抓取View的当前状态，
 * 复制View的状态，将View还原至该状态等便捷方法
...
public class ViewState {
    ...
    /**缩略图初始*/
    public static final int STATE_ORIGIN = R.id.state_origin;
    /**缩略图居中*/
    public static final int STATE_THUMB = R.id.state_thumb;
    /**高清图初始*/
    public static final int STATE_DEFAULT = R.id.state_default;
    /**当前状态*/
    public static final int STATE_CURRENT = R.id.state_current;
    /**临时目标*/
    public static final int STATE_TEMP = R.id.state_temp;
    /**高清图拖拽起点*/
    public static final int STATE_DRAG = R.id.state_touch_drag;
    /**高清图退出起点*/
    public static final int STATE_EXIT = R.id.state_exit;
    /**高清图缩放旋转起点*/
    public static final int STATE_TOUCH_SCALE = R.id.state_touch_scale_rotate;
            ...
            if (vsResult != null) {
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(ValueAnimator animation) {
                        ...
                        view.setTranslationX(vsCurrent.translationX +
                                (vsResult.translationX - vsCurrent.translationX) * p);
                        view.setTranslationY(vsCurrent.translationY +
                                (vsResult.translationY - vsCurrent.translationY) * p);
                        ...
                        if (vsCurrent.width != vsResult.width && vsCurrent.height != vsResult.height
                            ...
                            view.getLayoutParams().width = (int) (vsCurrent.width +
                                    (vsResult.width - vsCurrent.width) * p);
                            view.getLayoutParams().height = (int) (vsCurrent.height +
                                    (vsResult.height - vsCurrent.height) * p);
                            view.requestLayout();
                        }
                    }
                });

 ...
 * @time: 16:44
 */
public class CircleFriendsPresenter extends BasePresenter<CircleFriendsContract.view>
        implements CircleFriendsContract.Presenter {
    ...
    @Override
    public void getCircleFriendsDatas() {

        mView.setCircleFriendsDatas(get());
